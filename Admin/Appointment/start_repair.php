...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($data['appointment_id'])) {
        ...
        if ($stmt->execute()) {
            echo json_encode(['success' => true, 'message' => 'Lịch hẹn đã đan đang được sửa chữa.']);
        } else {
            echo json_encode(['success' => false, 'message' => 'Xác nhận lịch hẹn chưa chuyển sang sửa chữa.']);
        }
