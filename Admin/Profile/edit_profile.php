...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE users SET username = ?, email = ?, fullname = ?, address = ?, phonenum = ?, birthday = ?, gender = ? WHERE uid = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param('ssssssii', $username, $email, $fullname, $address, $phonenum, $birthday, $gender,  $uid);
