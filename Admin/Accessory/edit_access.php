...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   $accessory_id  = $decodedData['accessory_id'] ?? ''; 
   ...
   $supplier = $decodedData['supplier'] ?? '';
    ...
    $query = "UPDATE accessory SET accessory_name = ?, description = ?,  price = ?,  quantity = ?, supplier=?  WHERE accessory_id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param('ssiisi', $accessory_name, $description, $price, $quantity, $supplier, $accessory_id);
